<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="app3.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Inicio" runat="server">
    ...
    <div class="fl_right">
                <h2><asp:HyperLink ID="TituloPrincipal" runat="server" ForeColor="#CCCCCC" NavigateUrl="~/noticias.aspx"></asp:HyperLink></h2>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Navegalogin" runat="server">
    ...
    <table class="Tablita">
    <tr>
        <td class="toper"><asp:Label ID="Label1" runat="server" Text="Usuario:" CssClass="casilla"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" CssClass="casilla" Width="140px" MaxLength="50"></asp:TextBox></td>
        <td ><asp:Button ID="Button1" runat="server" Text="Ingresar" CssClass="boton" OnClick="Button1_Click"/></td>
    </tr>
    <tr>
        <td class="toper"><asp:Label ID="Label2" runat="server" Text="Contraseña:"></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" CssClass="casilla" TextMode="Password" Width="140px" MaxLength="50"></asp:TextBox></td>
        <td ><asp:Button ID="Button2" runat="server" Text="Registrar" CssClass="boton" OnClick="Button2_Click" /></td>     
    </tr>
    </table>
    <ul>
        <li class="last">
          <p class="readmore"><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/olvidocon/olvido.aspx">He olvidado mi contraseña &raquo;</asp:HyperLink></p>
        </li>
   </ul>
   </div>
  </div>
